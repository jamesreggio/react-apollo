    ...
    function wrapWithApolloComponent(WrappedComponent) {
        ...
        class GraphQL extends React.Component {
            ...
            fetchData() {
                ...
                const observable = this.getClient(this.props).watchQuery(Object.assign({ query: document }, opts));
            ...
            render() {
                if (this.shouldSkip()) {
                    if (operationOptions.withRef) {
                        return (React.createElement(WrappedComponent, Object.assign({}, Object.assign({}, this.props, {
