...
function observableQueryFields(observable) {
    var obj = {};
    observableQueryKeys.forEach(function (key) {
        if (!(key in observable))
            return;
        var val = observable[key];
    ...
    function wrapWithApolloComponent(WrappedComponent) {
        ...
        var GraphQL = (function (_super) {
            ...
            GraphQL.prototype.setInitialProps = function () {
                ...
                this.lastKey = opts.key;
                this.createQuery(opts);
            };
            GraphQL.prototype.createQuery = function (opts, props) {
                if (props === void 0) { props = this.props; }
                if (this.type === parser_1.DocumentType.Subscription) {
                    this.queryObservable = this.getClient(props).subscribe(Object.assign({ query: document }, opts));
                }
                else {
                    var recycler = this.getQueryRecycler();
                    ...
                    if (queryObservable === null) {
                        this.queryObservable = this.getClient(props).watchQuery(Object.assign({
                            query: document,
                            metadata: {
                                reactComponent: {
            ...
            GraphQL.prototype.updateQuery = function (props) {
                ...
                if (!shallowEqual(nextKey, this.lastKey)) {
                    this.previousData = {};
                }
                if (!this.queryObservable) {
            ...
            GraphQL.prototype.fetchData = function () {
                ...
                var observable = this.getClient(this.props).watchQuery(Object.assign({ query: document }, opts));
            ...
            GraphQL.prototype.dataForChild = function () {
                ...
                if (this.type === parser_1.DocumentType.Subscription) {
                    ...
                    Object.assign(data, { loading: loading, networkStatus: networkStatus });
            ...
            GraphQL.prototype.render = function () {
                if (this.shouldSkip()) {
                    if (operationOptions.withRef) {
                        return (React.createElement(WrappedComponent, __assign({}, Object.assign({}, this.props, {
                ...
                var mergedPropsAndData = Object.assign({}, props, clientProps);
                if (operationOptions.withRef)
